...
For languages other than English and Chinese Simplified, please don't create pull requests for translations; instead, use [Crowdin](https://crowdin.com/project/SakiSU).

## Reporting bugs

Before reporting a bug, please first read the [document](https://XingChenRS.github.io/SakiSU)
...
When you [Open an issue](https://github.com/XingChenRS/SakiSU/issues), you **must**:
...
[Open an issue](https://github.com/XingChenRS/SakiSU/issues) describing the feature you want and your reason for it.
...
```
>- then Joe Smith would upload the patch for SakiSU as
```
